<a name="4.2.1"></a>
Feita uma alteração ao plugin.xml. Foram adicionadas as seguintes linhas para passar a usar WKWebView em vez de UIWebView.
<!-- Facebook SDK -->
<podspec>
    <config>
    ...
    <pods use-frameworks="true">
        <pod name="FBSDKCoreKit" spec="5.5.0"/>
        <pod name="FBSDKLoginKit" spec="5.5.0"/>
        <pod name="FBSDKShareKit" spec="5.5.0"/>
    </pods>
</podspec>
